(() => {
  ...
  var button_default = buttons = () => {
    (0, import_jquery.default)("button").each((i, button) => {
      let $button = (0, import_jquery.default)(button);
      let btnCounter = 1;
      let counter = $button.find("span");
      $button.click(() => {
        counter.text(btnCounter++);
      });
    });
  };
  ...
  (0, import_jquery2.default)(document).ready(() => {
    button_default();
    (0, import_jquery2.default)(".menuContain").load("menu.html");
  });
})();
/*!
